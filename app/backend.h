...
signals:
    ...
    void notifyEncrypted(int err, QString cipher_text, QString salt);
...
public slots:
    ...
    void encrypt(const QString& cipher_alg_id, const QString &pass, const QString& plain_text_file);
};
